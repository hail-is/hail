...
**Supported comparisons and transformations:**
 ...
 - Array Operations:
     ...
     - exists: `arr.exists(v => expr)` -- Returns a boolean which is true if any element satisfied `expr`, false otherwise
 ...
 - Set Operations: 
     ...
     - exists: `set.exists(v => expr)` -- Returns a boolean which is true if any element satisfied `expr`, false otherwise
