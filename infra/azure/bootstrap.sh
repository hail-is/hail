...
init_terraform() {
    RESOURCE_GROUP=${RESOURCE_GROUP:-$1}
    # TODO
    STORAGE_ACCOUNT_NAME=${STORAGE_CONTAINER_NAME:-"2498dgoldste"}
...
EOF
    ...
    terraform init -backend-config=$remote_storage_access_key -backend-config=remote_storage.tfvars -upgrade
}
