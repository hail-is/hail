import { hailApiFetch, hailApiFetchVoid } from './hailApiFetch';
...
export function createHailApi(basePath: string) {
  return {
    ...
    cancelBatch: (batchId: string) =>
      hailApiFetchVoid(`${basePath}/api/v1alpha/batches/${batchId}/cancel`, { method: 'PATCH' }),

    deleteBatch: (batchId: string) =>
      hailApiFetchVoid(`${basePath}/api/v1alpha/batches/${batchId}`, { method: 'DELETE' }),
  };
}
