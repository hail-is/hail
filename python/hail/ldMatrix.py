...
class LDMatrix:
    """
    Represents a symmetric matrix encoding the correlation between each pair of variants in the accompanying variant list.
    """
    ...
    def variant_list(self):
        """
        Gets the list of variants. The (i, j) entry of the matrix encodes the correlation between the ith and jth variants.
