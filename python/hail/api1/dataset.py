...
class VariantDataset(HistoryMixin):
    ...
    def from_table(cls, table):
        ...
        **Notes**
        ...
        """
        jvds = scala_object(Env.hail().variant, 'MatrixTable').fromRowsTable(table._jkt)
...
'''
    ...
    @typecheck_method(k=integral,
                      ...
                      as_array=bool)
    def pca_of_normalized_genotypes(self, k=10, compute_loadings=False, as_array=False):
        ...
        if nVariants == 0:
            raise FatalError("Cannot run PCA: found 0 variants after filtering out variants that are all homozygous reference or all homozygous variant.")
...
'''
    ...
    def to_hail2(self):
        import hail2
        return hail2.MatrixTable(self._jvds)
