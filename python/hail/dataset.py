...
class VariantDataset(object):
    ...
    def annotate_genotypes_expr(self, expr):
        ...
        **Examples**
        ...
        Convert the genotype schema to a :py:class:`~hail.representation.Struct` with two fields ``GT`` and ``CASE_HET``:
        ...
        :py:class:`~hail.representation.Genotype`
        ...
        **Notes**
        ...
        .. warning::
            ...
            - If the resulting genotype schema is not :py:class:`~hail.representation.Genotype`,
            ...
            - Hail performance may be significantly slower if the annotated variant dataset does not have a
              genotype schema equal to :py:class:`~hail.representation.Genotype`.
    ...
    def count(self, genotypes=False):
        ...
        :param bool genotypes: If True, include number of called
            ...
            schema does not equal :py:class:`~hail.representation.Genotype`, the definition of "called" is the genotype cell (``g``) is
            not missing.
    ...
    def export_genotypes(self, output, expr, types=False, export_ref=False, export_missing=False):
        ...
        **Notes**
        ...
        .. warning::
            ...
            If the genotype schema does not have the type :py:class:`~hail.representation.Genotype`, all genotypes will be exported unless the value of ``g`` is missing.
        ...
        :param bool export_ref: If True, export reference genotypes. Only applicable if the genotype schema is :py:class:`~hail.representation.Genotype`.
    ...
    def export_vcf(self, output, append_to_header=None, export_pp=False, parallel=False):
        ...
        **Notes**
        ...
        The genotype schema must have the type :py:class:`~hail.representation.Genotype` or :py:class:`~hail.representation.Struct`. If the type is
        :py:class:`~hail.representation.Genotype`, then the FORMAT fields will be GT, AD, DP, GQ, and PL (or PP if ``export_pp`` is True).
        If the type is :py:class:`~hail.representation.Struct`, then the exported FORMAT fields will be the names of each field of the Struct.
