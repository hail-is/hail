...
class VariantDataset(object):
    ...
    def linreg(self, y, covariates=[], root='va.linreg', minac=1, minaf=0.0):
        ...
        **Annotations**
        ...
        try:
            return VariantDataset(self.hc, self.hc.jvm.org.broadinstitute.hail.methods.LinearRegression.apply(self.jvds, y, jarray(self.hc.gateway, self.hc.jvm.java.lang.String, covariates), root, minac, minaf))
        except Py4JJavaError as e:
            self._raise_py4j_exception(e)
    ...
    def logreg(self, test, y, covariates=[], root='va.logreg'):
        ...
        **Notes**
        ...
        try:
            return VariantDataset(self.hc, self.hc.jvm.org.broadinstitute.hail.methods.LogisticRegression.apply(self.jvds, test, y, jarray(self.hc.gateway, self.hc.jvm.java.lang.String, covariates), root))
        except Py4JJavaError as e:
            self._raise_py4j_exception(e)
