...
Download the Hail distribution from our  :ref:`getting started <sec-getting_started>`. Inside, you'll find
a ``tutorials/`` directory. ``cd`` to this directory and run ``sh hail-jupyter.sh`` to get start the notebook
server, then click one of the notebooks to begin!
