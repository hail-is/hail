...
def lmmreg(ds, kinshipMatrix, y, x, covariates=[], global_root="global.lmmreg", va_root="va.lmmreg",
    ...
    **Performance**
    ...
    Hail's initial version of :py:meth:`.lmmreg` scales beyond 15k samples and
