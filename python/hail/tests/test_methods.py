...
class Tests(unittest.TestCase):
    ...
    def test_variant_qc(self):
        ...
        self.assertEqual(r[0].vqc.hwe[0].r_expected_het_freq, 0.6)
        self.assertEqual(r[0].vqc.hwe[0].p_hwe, 0.7)
        ...
        self.assertAlmostEqual(r[1].vqc.hwe[0].r_expected_het_freq, 0.5333333333333333)
        self.assertEqual(r[1].vqc.hwe[0].p_hwe, 0.6)
        self.assertEqual(r[1].vqc.hwe[1].r_expected_het_freq, 0.5)
        self.assertEqual(r[1].vqc.hwe[1].p_hwe, 0.5)
