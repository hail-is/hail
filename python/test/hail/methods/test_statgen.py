...
class Tests(unittest.TestCase):
    ...
    def test_split_multi_hts(self):
        ...
        ds1.select_rows().select_cols().entries().show(50, width=200)
        ...
        ds1.select_rows('was_split', 'a_index').select_cols().entries().show(50, width=200)
        ds2.select_rows().select_cols().entries().show(50, width=200)
