    ...
    def test_matrix_ir_parses(self):
        ...
        matrix_irs = [
            ...
            ir.UnlocalizeEntries(
                ...
                ir.MatrixColsTable(matrix_read),
                '__entries'),
            ir.MatrixAggregateRowsByKey(matrix_read, ir.MakeStruct([('x', ir.I32(2))]), ir.MakeStruct([('y', ir.I32(2))])),
            ir.MatrixAggregateColsByKey(matrix_read, ir.MakeStruct([('x', ir.I32(2))]), ir.MakeStruct([('y', ir.I32(2))])),
