...
compileHail := ("make -C ../hail shadowJar" !)
...
libraryDependencies ++= {
  ...
  Seq("com.typesafe.akka" %% "akka-http"   % "10.1.9"
    , "com.typesafe.akka" %% "akka-stream" % "2.5.23"
    , "is.hail" % "Hail" % "0.1" from s"file://${Paths.get("..").toAbsolutePath}/hail/build/libs/hail-all-spark.jar"
    // hail deps
