...
mt = hl.read_matrix_table('gs://hail-datasets/hail-data/ukbb_imputed_v3_gwas_results_female.GRCh37.mt')
...
mt.describe()
mt.write('gs://hail-datasets/hail-data/ukbb_imputed_v3_gwas_results_female.GRCh38.liftover.mt', overwrite=True)
