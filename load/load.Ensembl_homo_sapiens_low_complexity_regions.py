...
version = f'release{args.v}'
build = args.b

ht = hl.import_table(f'{raw_data_root}/Ensembl_homo_sapiens_low_complexity_regions_{version}_{build}.tsv.bgz')
...
path = f'{hail_data_root}/{name}.{version}.{build}.ht'
