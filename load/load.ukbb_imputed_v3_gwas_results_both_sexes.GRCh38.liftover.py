...
mt = hl.read_matrix_table('gs://hail-datasets/hail-data/ukbb_imputed_v3_gwas_results_both_sexes.GRCh37.mt')
...
mt.describe()
mt.write('gs://hail-datasets/hail-data/ukbb_imputed_v3_gwas_results_both_sexes.GRCh38.liftover.mt', overwrite=True)
