// adapted and modified from https://cdn.jsdelivr.net/npm/@tarekraafat/autocomplete.js@7.2.0/dist/js/autoComplete.min.js
var a, b;
a = this,
b = function() {
    "use strict";
    ...
    return function() {
        function K(e) {
            ...
            var t = e.selector
              , n = void 0 === t ? ".autoComplete" : t //TODO: this should probably be ".autoComplete"
              , i = e.data
              , o = i.key
              , r = i.src
              , s = i.cache
