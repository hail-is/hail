...
parser.add_argument('--name', '-n', required=True, type=str, help="Cluster name")
parser.add_argument('--dest', '-d', required=True, type=str, help="Directory for diagnose output -- must be local")
parser.add_argument('--hail-log', '-l', required=False, type=str, default='/home/hail/hail.log', help="Path for hail.log file")
parser.add_argument('--overwrite', required=False, action='store_true', help="Delete dest directory before adding new files")
parser.add_argument('--no-diagnose', required=False, action='store_true', help="Do not run gcloud dataproc clusters diagnose")
...
parser.add_argument('--take', required=False, type=int, default=None, help="Only download logs from the first N workers")
