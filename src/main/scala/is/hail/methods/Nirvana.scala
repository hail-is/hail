...
object Nirvana {
  ...
  val nirvanaSignature = TStruct(
    ...
    //"quality" -> TFloat64,                 //Derived from QUAL, leaving out
    "filters" -> TArray(TString),
    //"jointSomaticNormalQuality" -> TInt32,  //Derived from INFO, leaving out
    //"copyNumber" -> TInt32,                 //Derived from INFO, leaving out
    //"strandBias" -> TFloat64,              //Derived from INFO, leaving out
    //"recalibratedQuality" -> TFloat64,     //Derived from INFO, leaving out
