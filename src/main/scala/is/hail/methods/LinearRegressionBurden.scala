...
object LinearRegressionBurden {
  ...
  def apply(vds: VariantDataset, groupVariantsBy: String, aggregateWith: String, genotypeExpr: String, ySA: String, covSA: Array[String], minAC: Int, minAF: Double): KeyTable = {
