...
sealed case class Let(name: String, value: IR, typ: Type, body: IR) extends IR
...
sealed case class MapNA(name: String, value: IR, valueTyp: Type, body: IR, bodyTyp: Type) extends IR
