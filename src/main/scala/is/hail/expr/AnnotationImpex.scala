...
object SparkAnnotationImpex extends AnnotationImpex[DataType, Any] {
  ...
  def importAnnotation(a: Any, t: Type): Annotation = {
    if (a == null)
      ...
      t match {
        ...
        case t: TInterval =>
          val r = a.asInstanceOf[Row]
          Interval(importAnnotation(r.get(0), TLocus(t.gr)).asInstanceOf[Locus], importAnnotation(r.get(1), TLocus(t.gr)).asInstanceOf[Locus])
        case TStruct(fields) =>
          if (fields.isEmpty)
  ...
  def exportType(t: Type): DataType = (t: @unchecked) match {
    ...
    case t: TVariant => Variant.sparkSchema
    case t: TLocus => Locus.sparkSchema
    case t: TInterval => StructType(Array(
...
object TableAnnotationImpex extends AnnotationImpex[Unit, String] {
  ...
  def importAnnotation(a: String, t: Type): Annotation = {
    (t: @unchecked) match {
      ...
      case t: TLocus => Locus.parse(a)
      case t: TInterval => Locus.parseInterval(a)
      case t: TVariant => Variant.parse(a)
