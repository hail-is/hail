...
object AbsoluteFuzzyComparable {
  ...
  def absoluteEq[T](tolerance: Double, x: T, y: T)(implicit afc: AbsoluteFuzzyComparable[T]): Boolean =
  ...
  implicit def afcMaps[K, V](implicit vRFC: AbsoluteFuzzyComparable[V]): AbsoluteFuzzyComparable[Map[K, V]] =
