...
object VariantQCCombiner {
  ...
  val signatures = Map("nCalled" -> new VCFSignature("Int", "toInt", ""),
    ...
    "MAF" -> new VCFSignature("Option[Double]", "toOptionDouble", ""),
    "nNonRef" -> new VCFSignature("Int", "toInt", ""),
    "rHeterozygosity" -> new VCFSignature("Option[Double]", "toOptionDouble", ""),
    "rHetHomVar" -> new VCFSignature("Option[Double]", "toOptionDouble", ""),
    "rExpectedHetFrequency" -> new VCFSignature("Option[Double]", "toOptionDouble", ""),
