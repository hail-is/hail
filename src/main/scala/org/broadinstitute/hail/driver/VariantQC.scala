...
object VariantQCCombiner {
  ...
  val signatures = Map("callRate" -> new SimpleSignature(ClassOf[Double], true),
    "MAC" -> new SimpleSignature(ClassOf[Int]),
    "MAF" -> new SimpleSignature(ClassOf[Double], true),
    ...
    "rHeterozygosity" -> new SimpleSignature(ClassOf[Double], true),
    "rHetHomVar" -> new SimpleSignature(ClassOf[Double], true),
    "rExpectedHetFrequency" -> new SimpleSignature(ClassOf[Double], true),
    "pHWE" -> new SimpleSignature(ClassOf[Double], true))
}
