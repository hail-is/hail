package org.broadinstitute.k3.io.compress
...
class BGzipCodecSuite extends SparkSuite {
  @Test def test() {
    sc.hadoopConfiguration.set("io.compression.codecs", "org.apache.hadoop.io.compress.DefaultCodec,org.broadinstitute.k3.io.compress.BGzipCodec,org.apache.hadoop.io.compress.GzipCodec")
