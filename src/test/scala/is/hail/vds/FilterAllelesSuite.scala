...
import is.hail.variant.{AltAllele, Genotype, GenotypeMatrixT, VSMFileMetadata, VSMSubgen, Variant, VariantSampleMatrix}
...
class FilterAllelesSuite extends SparkSuite {
  ...
  @Test def filterSecondOfTwoAllelesDowncode(): Unit = {
    ...
    val vds = new VariantSampleMatrix[GenotypeMatrixT](hc, VSMFileMetadata(Array("1", "2", "3"),
