...
class ExtractAggregatorsSuite {
  ...
  def sum() {
    ...
    val aOff = addArray(region, (0 to 100).map(_.toDouble):_*)
  ...
  def sumEmpty() {
    val tAgg = TAggregable(TFloat64(), Map("foo" -> (0, TInt32())))
    val region = MemoryBuffer()
    val aOff = addArray[Double](region)
  ...
  def sumOne() {
    val tAgg = TAggregable(TFloat64(), Map("foo" -> (0, TInt32())))
    val region = MemoryBuffer()
    val aOff = addArray[Double](region, 42.0)
  ...
  def sumMissing() {
    val tAgg = TAggregable(TFloat64(), Map("foo" -> (0, TInt32())))
    val region = MemoryBuffer()
    val aOff = addBoxedArray[java.lang.Double](region, null, 42.0, null)
  ...
  def sumAllMissing() {
    val tAgg = TAggregable(TFloat64(), Map("foo" -> (0, TInt32())))
    val region = MemoryBuffer()
    val aOff = addBoxedArray[java.lang.Double](region, null, null, null)
  ...
  def usingScope2() {
    val tAgg = TAggregable(TFloat64(), Map("foo" -> (0, TInt32())))
    val region = MemoryBuffer()
    val aOff = addBoxedArray[java.lang.Double](region, 1.0, 2.0, null)
  ...
  def usingScope3() {
    ...
    val region = MemoryBuffer()
    val aOff = addBoxedArray[java.lang.Double](region, 1.0, 10.0, null)
