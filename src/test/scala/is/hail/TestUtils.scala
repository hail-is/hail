...
object TestUtils {
  ...
  def assertEvalThrows(
    ...
    interceptFatal(regex)(Interpret[Any](x, env, args, agg))
    interceptFatal(regex)(Interpret[Any](x, env, args, agg, optimize = false))
    ...
    val c = agg match {
      case Some((aggElements, aggType)) =>
        ...
        Region.scoped { region =>
          ...
          interceptFatal(regex) {
            ...
            f()(region, aggResultsOff, false, argsOff, false)
          }
        }
      ...
      case None =>
        ...
        Region.scoped { region =>
          ...
          interceptFatal(regex)(f()(region, argsOff, false))
        }
    }
  }
}
