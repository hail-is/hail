    ...
    if os.getenv('MOCK_API_DATA'):
        ...
        async def retried_tests_mock(request: web.Request):
            rows = [
                ...
                {'id': 110, 'batch_id': 8910, 'job_id': 3, 'job_name': 'test_hail_python_1',                    'state': 'Failed',  'exit_code': 1, 'pr_number': 15287, 'target_branch': 'main', 'source_branch': 'feat-a',      'source_sha': 'aa0001', 'retried_by': 'ci', 'retried_at': '2026-03-06T21:10:00'},
                ...
                {'id': 106, 'batch_id': 8870, 'job_id': 2, 'job_name': 'test_hail_python_unchecked_allocator_3','state': 'Error', 'exit_code': None, 'pr_number': 15279, 'target_branch': 'main', 'source_branch': 'bugfix-2',    'source_sha': 'aa0005', 'retried_by': 'ci', 'retried_at': '2026-03-05T22:40:00'},
                ...
                {'id': 104, 'batch_id': 8850, 'job_id': 2, 'job_name': 'test_hail_python_unchecked_allocator_3','state': 'Failed',  'exit_code': 1, 'pr_number': 15275, 'target_branch': 'main', 'source_branch': 'refactor-y',  'source_sha': 'aa0007', 'retried_by': 'ci', 'retried_at': '2026-03-05T11:30:00'},
                ...
                {'id': 101, 'batch_id': 8820, 'job_id': 3, 'job_name': 'test_hail_python_1',                    'state': 'Failed',  'exit_code': 1, 'pr_number': 15268, 'target_branch': 'main', 'source_branch': 'type-fixes',  'source_sha': 'aa0009', 'retried_by': 'ci', 'retried_at': '2026-03-04T10:20:00'},
                ...
                {'id':  98, 'batch_id': 8790, 'job_id': 2, 'job_name': 'test_hail_python_unchecked_allocator_3','state': 'Failed',  'exit_code': 1, 'pr_number': 15261, 'target_branch': 'main', 'source_branch': 'schema-v2',   'source_sha': 'aa0010', 'retried_by': 'ci', 'retried_at': '2026-03-02T22:30:00'},
                {'id':  97, 'batch_id': 8780, 'job_id': 3, 'job_name': 'test_hail_python_1',                    'state': 'Failed',  'exit_code': 1, 'pr_number': 15258, 'target_branch': 'main', 'source_branch': 'cleanup-2',   'source_sha': 'aa0011', 'retried_by': 'ci', 'retried_at': '2026-03-02T16:50:00'},
