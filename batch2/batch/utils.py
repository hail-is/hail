...
def format_cost(n_msec_mcpu):
    # cost = (msec * mcpu) * (dollars / sec * cpu) * (1 sec / 1000 msec) * (1 cpu / 1000 mcpu)
    cost_per_core_sec = 0.01 / 3600
    cost = n_msec_mcpu * cost_per_core_sec * 0.001 * 0.001
    return f'${cost:.4f}'
