...
python3 devbin/sync.py \
    ...
    --path batch/batch /usr/local/lib/python3.11/dist-packages/ \
    --path gear/gear /usr/local/lib/python3.11/dist-packages/ \
    --path web_common/web_common /usr/local/lib/python3.11/dist-packages/ \
    --path hail/python/hailtop /usr/local/lib/python3.11/dist-packages/
```
