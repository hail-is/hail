...
raw_data_root = 'gs://hail-common/datasets-raw/Ensembl'
hail_data_root = 'gs://hail-common/datasets/1'
...
ht = hl.import_table(f'{raw_data_root}/Ensembl_homo_sapiens_reference_genome_release{version}.{build}.tsv.bgz', min_partitions=300)
