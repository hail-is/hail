...
mt = hl.import_matrix_table('gs://hail-datasets/raw-data/gtex/v7/rna-seq/processed/GTEx_Analysis_2016-01-15_v7_RNASeQCv1.1.8_gene_tpm.tsv.bgz',
...
mt = mt.rename({'x': 'TPM'})
mt = mt.drop(mt.col_id, mt.Name, mt.Description)

mt = mt.annotate_cols(**ht_samples[mt.sample_id])
mt = mt.annotate_rows(**ht_genes[mt.gene_id])

mt.describe()
mt.write('gs://hail-datasets/hail-data/gtex_v7_gene_tpm.GRCh37.mt', overwrite=True)
