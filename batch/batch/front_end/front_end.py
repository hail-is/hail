...
''',
    ...
    for spec in job_specs:
        ...
        if spec['process']['type'] == 'jvm':
            ...
            if 'cpu' in resources and jvm_requested_cpu not in (500, 1000, 2000, 4000, 8000):
                raise web.HTTPBadRequest(reason='invalid cpu for jvm jobs. must be 0.5, 1, 2, 4, or 8')
