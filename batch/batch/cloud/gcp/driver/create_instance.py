...
from ..resource_utils import gcp_machine_type_to_worker_type_and_cores, machine_type_to_gpu
...
def create_vm_config(
    ...
    accelerator_family = machine_type.split("-")[0]
    docker_run_gpu_args = "--runtime=nvidia --gpus all" if machine_type_to_gpu(accelerator_family) else ""
        ...
        'disks': [
            {
                ...
                'autoDelete': True,
                'initializeParams': {
                    'sourceImage': f'projects/{project}/global/images/batch-worker-parsa-100',
                    'diskType': f'projects/{project}/zones/{zone}/diskTypes/pd-ssd',
