...
from hailtop.aiocloud import aiolambda
...
log = logging.getLogger('lambda_resource_manager')
...
class LambdaResourceManager(CloudResourceManager):
    def __init__(
        self,
        project: str,
        compute_client: aiolambda.LambdaClient,  # BORROWED
        billing_manager: LambdaBillingManager,  # BORROWED
    ):
