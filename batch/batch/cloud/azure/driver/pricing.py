...
async def vm_prices_by_region(pricing_client: aioazure.AzurePricingClient,
                              region: str,
...
async def managed_disk_prices_by_region(pricing_client: aioazure.AzurePricingClient, region: str) -> List[AzureDiskPrice]:
...
async def fetch_prices(pricing_client: aioazure.AzurePricingClient, regions: List[str]) -> List[AzurePrice]:
    ...
    vm_coros = [vm_prices_by_region(pricing_client, region, machine_types)
