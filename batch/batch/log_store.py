...
class LogStore:
    def __init__(self, bucket_name, worker_logs_bucket_name, instance_id, blocking_pool, *, project=None, credentials=None):
    ...
    def worker_log_path(self, machine_name, log_file):
        ...
        return f'gs://{self.worker_logs_bucket_name}/batch/logs/{self.instance_id}/worker/{machine_name}/{log_file}'
