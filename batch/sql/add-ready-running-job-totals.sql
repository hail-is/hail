ALTER TABLE `job_groups_n_jobs_in_complete_states` ADD COLUMN n_ready INT NOT NULL DEFAULT 0, ALGORITHM=INSTANT;
ALTER TABLE `job_groups_n_jobs_in_complete_states` ADD COLUMN n_running INT NOT NULL DEFAULT 0, ALGORITHM=INSTANT;
ALTER TABLE `job_groups_n_jobs_in_complete_states` ADD COLUMN n_creating INT NOT NULL DEFAULT 0, ALGORITHM=INSTANT;
