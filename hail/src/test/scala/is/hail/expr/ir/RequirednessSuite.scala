...
class RequirednessSuite extends HailSuite with MonadRunSupport {
...
//  }
  ...
  @Test def testTableReader() {
    ...
    CompileAndEvaluate[Lower, Any](TableWrite(table, TableNativeWriter(path)), false).runA(ctx, LoweringState())
