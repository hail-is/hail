...
class IRSuite extends HailSuite {
  ...
  @Test def testMakeArrayInferPTypeIntegrationTest() {
    ...
    val allRequired1 = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))), // duplicate key-value pair
      MakeTuple.ordered(FastIndexedSeq(I32(6), Str("b"))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), Str("b"))),
      MakeTuple.ordered(FastIndexedSeq(I32(4), Str("b")))
    ), TArray(TTuple(FastIndexedSeq(TInt32(), TString()): _*)))

    val allRequired2 = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))), // duplicate key-value pair
      MakeTuple.ordered(FastIndexedSeq(I32(6), Str("b"))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), Str("b"))),
      MakeTuple.ordered(FastIndexedSeq(I32(4), Str("g")))
    ), TArray(TTuple(FastIndexedSeq(TInt32(), TString()): _*)))
    ...
    assertPType(ir, PArray(PDict(PInt32(true), PString(true), true), true))

    val allRequired3 = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))), // duplicate key-value pair
      MakeTuple.ordered(FastIndexedSeq(I32(6), Str("b"))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), Str("b"))),
    ...
    val keyNotRequired = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))), // duplicate key-value pair
    ...
    ir = MakeArray(
      FastSeq(
        ToDict(allRequired3),
        ToDict(keyNotRequired)
      ),
      TArray(TDict(TInt32(), TString()))
    )

    assertPType(ir, PArray(PDict(PInt32(false), PString(true), true), true))

    val allRequired4 = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))), // duplicate key-value pair
      MakeTuple.ordered(FastIndexedSeq(I32(6), Str("b"))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), Str("b"))),
    ...
    val valNotRequired = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), Str("a"))), // duplicate key-value pair
      MakeTuple.ordered(FastIndexedSeq(I32(6), NA(TString()))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), Str("b"))),
      MakeTuple.ordered(FastIndexedSeq(I32(4), Str("b")))
    ), TArray(TTuple(FastIndexedSeq(TInt32(), TString()): _*)))
    ...
    ir = MakeArray(
      FastSeq(
        ToDict(allRequired4),
        ToDict(valNotRequired)
      ),
      TArray(TDict(TInt32(), TString()))
    )

    assertPType(ir, PArray(PDict(PInt32(true), PString(false), true), true))

    val valArrayRequired = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(6), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(4), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString()))))
    ), TArray(TTuple(FastIndexedSeq(TInt32(), TArray(TString())): _*)))

    val valArrayNotRequired = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), NA(TString())), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(6), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(4), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString()))))
    ...
    ir = MakeArray(
      FastSeq(
        ToDict(valArrayRequired),
        ToDict(valArrayNotRequired)
      ),
      TArray(TDict(TInt32(), TArray(TString())))
    )

    assertPType(ir, PArray(PDict(PInt32(true), PArray(PString(false), true), true), true))

    val dictKeysValsRequired = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(6), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
    ...
    val dictKeysValsNotRequired = MakeArray(FastIndexedSeq(
      NA(TTuple(TInt32(), TArray(TString()))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(6), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(4), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString()))))
    ...
    ir = MakeArray(
      FastSeq(
        ToDict(dictKeysValsRequired),
        ToDict(dictKeysValsNotRequired)
      ),
      TArray(TDict(TInt32(), TArray(TString())))
    )
    ...
    val tupleValInnerNotRequired = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), NA(TString())), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(6), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
    ...
    ir = MakeArray(FastSeq(tupleValRequired, tupleValInnerNotRequired), TArray(TArray(TTuple(TInt32(), TArray(TString())))))

    assertPType(ir, PArray(PArray(PTuple(true, PInt32(true), PArray(PString(false), true)), true), true))

    val tupleValOuterRequired = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(6), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
    ...
    val tupleValOuterNotRequired = MakeArray(FastIndexedSeq(
      MakeTuple.ordered(FastIndexedSeq(I32(5), NA(TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(5), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(6), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(3), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString())))),
      MakeTuple.ordered(FastIndexedSeq(I32(4), MakeArray(FastSeq(Str("a"), Str("b")), TArray(TString()))))
    ...
    ir = MakeArray(FastSeq(tupleValOuterRequired, tupleValOuterNotRequired), TArray(TArray(TTuple(TInt32(), TArray(TString())))))

    assertPType(ir, PArray(PArray(PTuple(true, PInt32(true), PArray(PString(true), false)), true), true))

    val arrayElemOuterRequired = MakeArray(
      FastSeq(
    ...
    val arrayElemOuterNotRequired = MakeArray(
      FastSeq(
        NA(TArray(TInt32())),
        MakeArray(FastSeq(I32(1), I32(2)),TArray(TInt32()))
      ),
    ...
    ir = MakeArray(
      FastSeq(
        ToSet(arrayElemOuterRequired),
        ToSet(arrayElemOuterNotRequired)
      ),
      TArray(TSet(TArray(TInt32())))
    )
