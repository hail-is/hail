...
sealed abstract class TableIR extends BaseIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableIR
...
case class TableLiteral(
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableLiteral = {
      ...
      case None =>
        ...
        val scanBody = (ctx: IR) =>
          StreamAgg(
            ...
            "x",
            Let(
              FastSeq("n" -> ApplyAggOp(FastSeq(), FastSeq(), count)),
              AggLet(
                "key",
        ...
        val summary =
          Let(
            FastSeq("sortedPartData" -> sortedPartDataIR),
            MakeStruct(FastSeq(
              "ksorted" ->
                invoke(
                  "land",
                  TBoolean,
                  StreamFold(
                    ToStream(Ref("sortedPartData", sortedPartDataIR.typ)),
                    True(),
                    "acc",
                    "partDataWithIndex",
                    invoke(
                  ...
                  StreamFold(
                    ...
                    invoke(
                      ...
                      ApplyComparisonOp(
                        ...
                        GetField(
                          ArrayRef(
                            Ref("sortedPartData", sortedPartDataIR.typ),
                            Ref("i", TInt32) + I32(1),
                          ),
                          "minkey",
                        ),
  ...
  def fieldInserter(ctx: ExecuteContext, pLeft: PStruct, pRight: PStruct)
    ...
    val (Some(PTypeReferenceSingleCodeType(t: PStruct)), mk) =
      ir.Compile[AsmFunction3RegionLongLongLong](
        ctx,
        FastSeq(
          "left" -> SingleCodeEmitParamType(true, PTypeReferenceSingleCodeType(pLeft)),
          "right" -> SingleCodeEmitParamType(true, PTypeReferenceSingleCodeType(pRight)),
        ),
        FastSeq(typeInfo[Region], LongInfo, LongInfo),
        LongInfo,
        InsertFields(
          Ref("left", pLeft.virtualType),
...
case class TableRead(typ: TableType, dropRows: Boolean, tr: TableReader) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableRead = {
    assert(newChildren.isEmpty)
...
case class TableParallelize(rowsAndGlobal: IR, nPartitions: Option[Int] = None) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableParallelize = {
...
case class TableKeyBy(child: TableIR, keys: IndexedSeq[String], isSorted: Boolean = false)
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableKeyBy = {
...
case class TableRange(n: Int, nPartitions: Int) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableRange = {
    assert(newChildren.isEmpty)
...
case class TableFilter(child: TableIR, pred: IR) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableFilter = {
...
case class TableHead(child: TableIR, n: Long) extends TableSubset {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableHead = {
...
case class TableTail(child: TableIR, n: Long) extends TableSubset {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableTail = {
    val IndexedSeq(newChild: TableIR) = newChildren
...
case class TableRepartition(child: TableIR, n: Int, strategy: Int) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableRepartition = {
    val IndexedSeq(newChild: TableIR) = newChildren
...
case class TableJoin(left: TableIR, right: TableIR, joinType: String, joinKey: Int)
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableJoin = {
    assert(newChildren.length == 2)
    TableJoin(
...
case class TableMultiWayZipJoin(
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableMultiWayZipJoin =
...
case class TableLeftJoinRightDistinct(left: TableIR, right: TableIR, root: String) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableLeftJoinRightDistinct = {
...
object TableMapPartitions {
  def apply(child: TableIR, globalName: String, partitionStreamName: String, body: IR)
    : TableMapPartitions =
...
case class TableMapPartitions(
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableMapPartitions = {
    assert(newChildren.length == 2)
    TableMapPartitions(
      newChildren(0).asInstanceOf[TableIR],
      globalName,
...
case class TableMapRows(child: TableIR, newRow: IR) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableMapRows = {
    assert(newChildren.length == 2)
...
case class TableMapGlobals(child: TableIR, newGlobals: IR) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableMapGlobals = {
    assert(newChildren.length == 2)
...
case class TableExplode(child: TableIR, path: IndexedSeq[String]) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableExplode = {
    assert(newChildren.length == 1)
    ...
    val length: IR =
      Coalesce(FastSeq(
        ArrayLen(CastToArray(
          path.foldLeft[IR](Ref("row", childRowType))((struct, field) => GetField(struct, field))
        )),
        0,
      ))
...
case class TableUnion(childrenSeq: IndexedSeq[TableIR]) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableUnion =
...
case class MatrixRowsTable(child: MatrixIR) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): MatrixRowsTable = {
    assert(newChildren.length == 1)
...
case class MatrixColsTable(child: MatrixIR) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): MatrixColsTable = {
    assert(newChildren.length == 1)
...
case class MatrixEntriesTable(child: MatrixIR) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): MatrixEntriesTable = {
    assert(newChildren.length == 1)
...
case class TableDistinct(child: TableIR) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableDistinct = {
...
case class TableKeyByAndAggregate(
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableKeyByAndAggregate = {
...
case class TableAggregateByKey(child: TableIR, expr: IR) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableAggregateByKey = {
    assert(newChildren.length == 2)
...
case class TableOrderBy(child: TableIR, sortFields: IndexedSeq[SortField]) extends TableIR {
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableOrderBy = {
    val IndexedSeq(newChild) = newChildren
...
case class CastMatrixToTable(
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): CastMatrixToTable = {
    val IndexedSeq(newChild) = newChildren
...
case class TableRename(child: TableIR, rowMap: Map[String, String], globalMap: Map[String, String])
  ...
  override def withNewChildren(newChildren: IndexedSeq[BaseIR]): TableRename = {
    val IndexedSeq(newChild: TableIR) = newChildren
