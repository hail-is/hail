...
class GotoX(var lineNumber: Int) extends ControlX {
...
class IfX(val op: Int, var lineNumber: Int) extends ControlX {
...
class SwitchX(var lineNumber: Int) extends ControlX {
...
class StoreX(var l: Local, var lineNumber: Int) extends StmtX

class PutFieldX(val op: Int, val f: FieldRef, var lineNumber: Int) extends StmtX

class IincX(var l: Local, val i: Int, var lineNumber: Int) extends StmtX

class ReturnX(var lineNumber: Int) extends ControlX {
...
class ThrowX(var lineNumber: Int) extends ControlX {
  def targetArity(): Int = 0
...
class StmtOpX(val op: Int, var lineNumber: Int) extends StmtX

class MethodStmtX(val op: Int, val method: MethodRef, var lineNumber: Int) extends StmtX

class TypeInsnX(val op: Int, val t: String, var lineNumber: Int) extends ValueX {
  def ti: TypeInfo[_] = {
    assert(op == CHECKCAST)
...
class InsnX(val op: Int, _ti: TypeInfo[_], var lineNumber: Int) extends ValueX {
  def ti: TypeInfo[_] = {
    if (_ti != null)
      return _ti
...
class LoadX(var l: Local, var lineNumber: Int) extends ValueX {
  def ti: TypeInfo[_] = l.ti
}

class GetFieldX(val op: Int, val f: FieldRef, var lineNumber: Int) extends ValueX {
  def ti: TypeInfo[_] = f.ti
}

class NewArrayX(val eti: TypeInfo[_], var lineNumber: Int) extends ValueX {
  def ti: TypeInfo[_] = arrayInfo(eti)
}

class NewInstanceX(val ti: TypeInfo[_], val ctor: MethodRef, var lineNumber: Int) extends ValueX

class LdcX(val a: Any, val ti: TypeInfo[_], var lineNumber: Int) extends ValueX {
  assert(
...
class MethodX(val op: Int, val method: MethodRef, var lineNumber: Int) extends ValueX {
