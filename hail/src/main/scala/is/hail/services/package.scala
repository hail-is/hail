  ...
  def isLimitedRetriesError(_e: Throwable): Boolean = {
    ...
    e match {
      ...
      case e: SocketException
          if e.getMessage != null && (e.getMessage.contains("Connection reset") || e.getMessage.contains("Unexpected end of file")) =>
        true
  ...
  def isTransientError(_e: Throwable): Boolean = {
    ...
    e match {
      ...
      case e: HttpResponseException
        ...
        /* PUT
         * https://storage.googleapis.com/upload/storage/v1/b/hail-test-ezlis/o?name=tmp/hail/nBHPQsrxGvJ4T7Ybdp1IjQ/persist_TableObF6TwC6hv/rows/metadata.json.gz&uploadType=resumable&upload_id=ADPycdsFEtq65NC-ahk6tt6qdD3bKC3asqVSJELnirlpLG_ZDV_637Nn7NourXYTgMRKlX3bQVe9BfD_QfIP_kupTxVQyrJWQJrj */
        // {
        //   "error": {
        //     "code": 503,
