...
trait SBinaryCode extends SCode {
  ...
  def memoize(cb: EmitCodeBuilder, name: String)(implicit line: LineNumber): SBinaryValue

  def memoizeField(cb: EmitCodeBuilder, name: String)(implicit line: LineNumber): SBinaryValue
}
