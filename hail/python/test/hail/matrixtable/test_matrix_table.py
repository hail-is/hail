...
class Tests(unittest.TestCase):
    ...
    @fails_service_backend(reason='''intermittent worker error:
>       ds.locus.show()
...
Caused by: java.lang.ClassCastException: __C1914collect_distributed_array cannot be cast to is.hail.expr.ir.FunctionWithObjects
    ...
    @fails_service_backend(reason='''intermittent error:
...
''')
    ...
    @fails_service_backend(reason='''intermittent failure:
...
Caused by: java.lang.AssertionError: assertion failed
    ...
    @fails_service_backend(reason='''intermittent worker error, on this line:
...
https://hail.zulipchat.com/#narrow/stream/123011-Hail-Dev/topic/test_drop/near/235425714''')
    ...
    @fails_service_backend(reason='ShuffleRead non-deterministically causes segfaults')
    ...
    @fails_service_backend(reason='flaky https://hail.zulipchat.com/#narrow/stream/127527-team/topic/CI.20Deploy.20Failure/near/237593731')
...
Caused by: java.lang.ClassCastException: __C2308collect_distributed_array cannot be cast to is.hail.expr.ir.FunctionWithLiterals
    ...
    @fails_service_backend(reason='hangs >40 minutes; hangs after optimize optimize: darrayLowerer')
