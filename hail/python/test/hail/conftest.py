...
def pytest_collection_modifyitems(items):
    ...
    # Run tests that require no initialisation first
    items.sort(key=lambda i: 0 if item.get_closest_marker('uninitialized') is not None else 1)
