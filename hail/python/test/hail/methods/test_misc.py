...
class Tests(unittest.TestCase):
    def test_rename_duplicates(self):
        ...
        assert hl.rename_duplicates(mt.key_cols_by(s="0")).unique_id.collect() == [
            "0",
            "0_1",
            "0_2",
            "0_3",
    ...
    def test_maximal_independent_set(self):
        ...
        self.assertRaises(
            ValueError,
            lambda: hl.maximal_independent_set(graph.i, graph.bad_type, True),
        )
        self.assertRaises(
            ValueError,
            lambda: hl.maximal_independent_set(graph.i, hl.utils.range_table(10).idx, True),
        )
        self.assertRaises(
            ValueError,
            lambda: hl.maximal_independent_set(hl.literal(1), hl.literal(2), True),
        )
    ...
    def test_maximal_independent_set3(self):
        ...
        edges = [
            {
                "i": {"id": l, "is_case": l in is_case},
                "j": {"id": r, "is_case": r in is_case},
            }
            for l, r in edges
        ]
        ...
        t = hl.Table.parallelize(
            edges,
            hl.tstruct(
                i=hl.tstruct(id=hl.tstr, is_case=hl.tbool),
    ...
    def test_maximal_independent_set_types(self):
        ...
        ht = ht.annotate(
            i=hl.struct(a="1", b=hl.rand_norm(0, 1)),
            j=hl.struct(a="2", b=hl.rand_norm(0, 1)),
        )
        ht = ht.annotate(
            ii=hl.struct(id=ht.i, rank=hl.rand_norm(0, 1)),
    ...
    def test_matrix_filter_intervals(self):
        ...
        self.assertEqual(
            hl.filter_intervals(ds, [hl.parse_locus_interval("20:10639222-10644705")]).count_rows(),
            3,
        )
    ...
    def test_table_filter_intervals(self):
        ...
        self.assertEqual(
            hl.filter_intervals(ds, [hl.parse_locus_interval("20:10639222-10644705")]).count(),
            3,
        )
