...
class Tests(unittest.TestCase):
    ...
    @fails_service_backend(reason='hangs >3 hours after "Initializing google storage client"')
    ...
    @fails_service_backend(reason='hangs >3 hours after "all results complete" in ServiceBackend')
