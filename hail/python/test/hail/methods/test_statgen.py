...
class Tests(unittest.TestCase):
    ...
    @fails_when_service(reason='hangs >3 hours after "Initializing google storage client"')
    ...
    @fails_when_service(reason='hangs >3 hours after "all results complete" in ServiceBackend')
