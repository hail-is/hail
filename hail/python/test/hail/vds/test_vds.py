...
def get_impute_sex_chromosome_ploidy_ref_mt():
    ref_blocks = [
        hl.Struct(
            s="sample_xx",
            locus=hl.Locus("22", 1000000, "GRCh37"),
            END=2000000,
            GQ=15,
            DP=5,
        ),
        hl.Struct(
            s="sample_xx",
            locus=hl.Locus("X", X_PAR_END - 10, "GRCh37"),
            END=X_PAR_END + 9,
            GQ=18,
            DP=6,
        ),
        ...
        hl.Struct(
            s="sample_xy",
            locus=hl.Locus("Y", Y_PAR_END - 10, "GRCh37"),
            END=Y_PAR_END + 9,
            GQ=12,
            DP=4,
        ),
...
def test_to_dense_mt():
    ...
    as_dict = dense.aggregate_entries(
        hl.dict(
            hl.zip(
                hl.agg.collect((hl.str(dense.locus), dense.s)),
