...
def test_submit(runner, gcloud_run):
...
def test_cluster_and_script_required(runner, gcloud_run):
...
def test_script_args(runner, gcloud_run):
...
def test_files(runner, gcloud_run):
...
def test_properties(runner, gcloud_run):
...
def test_gcloud_configuration(runner, gcloud_run):
