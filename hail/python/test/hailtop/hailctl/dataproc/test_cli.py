...
def test_required_gcloud_version_met(runner, gcloud_run, monkeypatch):
...
def test_required_gcloud_version_unmet(runner, gcloud_run, monkeypatch):
...
def test_unable_to_determine_version(runner, gcloud_run, monkeypatch):
