...
class Test(unittest.TestCase):
    def test_deploy_external_default(self):
        ...
        self.assertEqual(
            deploy_config.external_url("quam", "/moo"),
            "https://quam.organization.tld/moo",
        )
    ...
    def test_deploy_external_bar(self):
        ...
        self.assertEqual(
            deploy_config.url("foo", "/moo"),
            "https://internal.organization.tld/bar/foo/moo",
        )
        self.assertEqual(
            deploy_config.external_url("foo", "/moo"),
            "https://internal.organization.tld/bar/foo/moo",
        )
