...
def _nearpsd(A):
    """ Obtain the "closest" positive semidefinite matrix to A.
    """
    n = A.shape[0]
...
def normalize_genotypes(genotype):
    ...
    mt = mt.annotate_entries(**{'gt_'+tid: genotype.n_alt_alleles() if genotype.dtype is dtype('call') else genotype})
