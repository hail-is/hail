...
def interact(obj):
    ...
    if isinstance(obj, hl.Table):
        glob = widgets.Button(description='globals', layout=widgets.Layout(width='150px', height='30px'))
        rows = widgets.Button(description='rows', layout=widgets.Layout(width='150px', height='200px'))
        ...
        glob = widgets.Button(description='globals', layout=widgets.Layout(width='65px', height='30px'))
        cols = widgets.Button(description='cols', layout=widgets.Layout(width='200px', height='30px'))
        rows = widgets.Button(description='rows', layout=widgets.Layout(width='65px', height='200px'))
        entries = widgets.Button(description='entries', layout=widgets.Layout(width='200px', height='200px'))
...
def get_type_html(t):
    if isinstance(t, hl.tdict):
        return (
            f'<p>A dictionary mapping keys to values.</p>\n'
            f'Documentation:\n<ul>'
        ...
        if hl.expr.types.is_numeric(t.element_type):
            return (
                f'<p>A variable-length array of homogenous numeric values.</p>\n'
                f'Documentation:\n<ul>'
            ...
            return (
                f'<p>A variable-length array of homogenous values.</p>\n'
                f'Documentation:\n<ul>'
        ...
        return (
            f'<p>A structure of named heterogeneous values.</p>\n'
            f'Documentation:\n<ul>'
        ...
        return (
            f'<p>A 0-indexed tuple of heterogeneous values.</p>\n'
            f'Documentation:\n<ul>'
        ...
        return (
            f'<p>An object representing an interval.</p>\n'
            f'Documentation:\n<ul>'
        ...
        return (
            f'<p>An object representing a genomic locus (chromomsome and position).</p>\n'
            f'Documentation:\n<ul>'
        ...
        return (
            f'<p>A 32-bit floating point number.</p>\n'
            f'Documentation:\n<ul>'
        ...
        return (
            f'<p>A 64-bit floating point number.</p>\n'
            f'Documentation:\n<ul>'
        ...
        return (
            f'<p>An object representing a genotype call.</p>\n'
            f'Documentation:\n<ul>'
