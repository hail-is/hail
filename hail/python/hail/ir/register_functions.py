...
def register_functions():
    ...
    def ndarray_floating_point_divide(arg_type, ret_type):
        ...
        register_function(
            "div",
            (tndarray(arg_type, NatVariable()), tndarray(arg_type, NatVariable())),
            tndarray(ret_type, NatVariable()),
        )
    ...
    register_function(
        ...
        dtype("struct{result:?U:locus,is_negative_strand:bool}"),
    )
    register_function(
        ...
        dtype("struct{result:interval<?U:locus>,is_negative_strand:bool}"),
    )
    register_function(
        "min_rep",
        (
    ...
    register_function(
        "local_to_global_g",
        (dtype("array<?T>"), dtype("array<int32>"), dtype("int32"), dtype("?T")),
        dtype("array<?T>"),
    )
    register_function(
        "local_to_global_a_r",
        (dtype("array<?T>"), dtype("array<int32>"), dtype("int32"), dtype("?T"), dtype("bool")),
        dtype("array<?T>"),
    )
    register_function(
        "index",
    ...
    register_function(
        ...
        dtype("struct{p_value: float64, odds_ratio: float64, ci_95_lower: float64, ci_95_upper: float64}"),
    )
    ...
    register_function(
        "index_bgen",
        (dtype("str"), dtype("str"), dtype("dict<str, str>"), dtype('bool'), dtype("int32")),
        dtype("int64"),
        (dtype("?T"),),
    )
    register_function(
        "getVCFHeader",
        (dtype("str"), dtype("str"), dtype("str"), dtype("str")),
        dtype(vcf_header_type_str),
    )
