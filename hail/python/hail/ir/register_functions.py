...
def register_functions():
    ...
    register_function("*", (dtype("?T:numeric"),dtype("array<?T>"),), dtype("array<?T>"))
    register_function("*", (dtype("array<?T:numeric>"),dtype("?T"),), dtype("array<?T>"))
    # register_function("*", (dtype("?T:ndarray"),dtype("?T:ndarray"),), dtype("?T:ndarray"))
    # register_function("*", (dtype("?T:ndarray"),dtype("?T:numeric"),), dtype("?T:ndarray"))
    # register_function("*", (dtype("?T:numeric"),dtype("?T:ndarray"),), dtype("?T:ndarray"))
