...
def register_functions():
    ...
    register_function(f"Locus", (dtype("str"),), dtype("?T:locus"))
    register_function(f"Locus", (dtype("str"), dtype("int32"),), dtype("?T:locus"))
    register_function(f"LocusAlleles", (dtype("str"),), dtype("struct{locus: ?T, alleles: array<str>}"))
    register_function(f"LocusInterval", (dtype("str"),dtype("bool"),), dtype("interval<?T:locus>"))
    register_function(f"LocusInterval", (dtype("str"),dtype("int32"),dtype("int32"),dtype("bool"),dtype("bool"),dtype("bool"),), dtype("interval<?T:locus>"))
    register_function(f"globalPosToLocus", (dtype("int64"),), dtype("?T:locus"))
    register_function(f"locusToGlobalPos", (dtype("?T:locus"),), dtype("int64"))
    register_function(f"liftoverLocus", (dtype(f"?T:locus"), dtype('float64'),), dtype(f"struct{{result:?U:locus,is_negative_strand:bool}}"))
    register_function(f"liftoverLocusInterval", (dtype(f"interval<?T:locus>"), dtype('float64'),), dtype(f"struct{{result:interval<?U:locus>,is_negative_strand:bool}}"))
