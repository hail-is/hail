...
def register_functions():
    ...
    def ndarray_floating_point_divide(arg_type, ret_type):
        register_function("/", (arg_type, hl.tndarray(arg_type, dtype("?T:nat")),), hl.tndarray(ret_type, dtype("?T")))
        register_function("/", (hl.tndarray(arg_type, dtype("?T:nat")), arg_type), hl.tndarray(ret_type, dtype("?T")))
        register_function("/", (hl.tndarray(arg_type, dtype("?T:nat")),
                                hl.tndarray(arg_type, dtype("?T"))), hl.tndarray(ret_type, dtype("?T")))
    ...
    register_function("+", (dtype("ndarray<?T:numeric, ?U:nat>"),dtype("ndarray<?T, ?U>"),), dtype("ndarray<?T, ?U>"))
    register_function("+", (dtype("ndarray<?T:numeric, ?U:nat>"),dtype("?T"),), dtype("ndarray<?T, ?U>"))
    register_function("+", (dtype("?T:numeric"),dtype("ndarray<?T, ?U:nat>"),), dtype("ndarray<?T, ?U>"))
