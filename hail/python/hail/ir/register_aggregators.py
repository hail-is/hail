...
def register_aggregators():
    ...
    linreg_aggregator_type = dtype('struct{xty:array<float64>,diag_inv:array<float64>,beta0:array<float64>,beta:array<float64>,standard_error:array<float64>,t_stat:array<float64>,p_value:array<float64>,multiple_standard_error:float64,multiple_r_squared:float64,adjusted_r_squared:float64,f_stat:float64,multiple_p_value:float64,n:int64}')
