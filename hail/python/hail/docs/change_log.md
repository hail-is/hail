...
- (hail#15328) upgrade uv to 0.10.x series
- (hail#15347) dont needlessly re-read liftover and fasta sequence index
- (hail#14762) Benchmark configurations
- (hail#15305) add `HailClassLoader` to `ContextRDD` Element Type
- (hail#15322) Expose driver maximum read parallelism
- (hail#15321) avoid jackson-databind version conflict
- (hail#15316) collect partition results as they complete
- (hail#15290) add `Compiled` alias for compiled functions
- (hail#15302) simplify `ControlX` target access patterns
- (hail#15303) `Trap` no more
