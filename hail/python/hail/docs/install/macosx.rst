...
- Install Java 21. For Apple silicon, we recommend using a `packaged installation from Azul
  <https://docs.azul.com/core/install/macos>`__
  ...
  You *must* pick a Java installation with a compatible architecture. If your processor uses Apple M-series silicon
...
- Install Python 3.12 or later. We recommend `Miniconda <https://docs.conda.io/en/latest/miniconda.html#macosx-installers>`__.
