...
Hail should work with any Spark 4.1.x cluster built with Scala 2.13.
...
.. code-block:: sh
    ...
    cd hail/hail
    make install-on-cluster HAIL_BUILD_MODE=Release HAIL_COMPILE_NATIVES=1 SPARK_VERSION=4.1.2
