...
class ServiceBackend(Backend):
    ...
    def __init__(
        ...
        *,
        ...
        self._requester_pays_configuration = None
        ...
        return await self._run_on_batch(
            ...
            service_backend_config=ServiceBackendRPCConfig(
                ...
                requester_pays_config=(
                    None if self.requester_pays_config is None else self._requester_pays_config,
                    None if isinstance(self._requester_pays_config, str) else self._requester_pays_config,
                ),
                custom_references=[
    ...
    def requester_pays_config(self) -> GCSRequesterPaysConfiguration | None:
        return self._requester_pays_configuration
    ...
    def requester_pays_config(self, config: GCSRequesterPaysConfiguration | None):
        ...
        self._requester_pays_configuration = config
