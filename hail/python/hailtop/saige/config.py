...
class JobConfigMixin(abc.ABC):
    image: Optional[str] = 'us-docker.pkg.dev/hail-vdc/hail/hailgenetics/saige:dev-hajvnjte0fv5'  # 'wzhou88/saige:1.3.0'  # FIXME: this image needs to support both SAIGE and hail
