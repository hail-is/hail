...
class Job:
    ...
    def regions(self, regions: Optional[List[str]]) -> Self:
        ...
        regions:
            ...
            to list the available regions to choose from.
...
class PythonJob(Job):
    ...
    .. code-block:: python
        ...
        b = Batch(default_python_image='hailgenetics/python-dill:3.12-slim')
    ...
    def image(self, image: str) -> 'PythonJob':
        ...
        Set the job's docker image to `hailgenetics/python-dill:3.12-slim`:

        >>> b = Batch()
        >>> j = b.new_python_job()
        >>> (j.image('hailgenetics/python-dill:3.12-slim')
        ...   .call(print, 'hello'))
        >>> b.run()  # doctest: +SKIP
