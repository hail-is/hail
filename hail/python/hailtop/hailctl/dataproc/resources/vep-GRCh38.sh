...
gsutil cp gs://hail-us-vep/vep95-GRCh38-loftee-gcloud.json /vep_data/vep95-GRCh38-gcloud.json
ln -s /vep_data/vep95-GRCh38-gcloud.json /vep_data/vep-gcloud.json

gsutil cat gs://hail-common/vep/vep/loftee-beta/${ASSEMBLY}.tar | tar -xf - -C /vep_data/ &
gsutil cat gs://hail-us-vep/Plugins.tar /vep_data/Plugins.tar | tar -xf - -C /vep_data
gsutil cat gs://hail-us-vep/homo-sapiens/95_${ASSEMBLY}.tar | tar -xf - -C /vep_data/homo_sapiens
