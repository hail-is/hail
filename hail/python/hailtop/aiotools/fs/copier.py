from typing import (Any, AsyncContextManager, Optional, List, Type, BinaryIO, cast, Set,
                    AsyncIterator, Union, Dict, Callable)
...
from ..utils import (retry_transient_errors, blocking_to_async, url_basename, url_join,
                     bounded_gather2, time_msecs, humanize_timedelta_msecs, OnlineBoundedGather2)
...
from .stream import (ReadableStream, WritableStream, blocking_readable_stream_to_async,
...
class LocalAsyncFS(AsyncFS):
    ...
    async def rmtree(self,
        ...
        async with OnlineBoundedGather2(sema) as pool:
            ...
            if tasks:
                await pool.wait(tasks)
>>>>>>> 6612d5dc1e... [hailtop] add hailtop.aiotools.delete:hail/python/hailtop/aiotools/fs.py
