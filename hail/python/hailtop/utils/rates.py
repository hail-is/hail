...
def rate_gib_hour_to_mb_msec(rate_gib_hour):
    rate_mb_hour = rate_gib_hour / 1024
    rate_mb_sec = rate_mb_hour / 3600
    return rate_mb_sec * 0.001


def rate_gib_month_to_mb_msec(rate_gib_month):
    ...
    return rate_gib_hour_to_mb_msec(rate_gib_hour)
