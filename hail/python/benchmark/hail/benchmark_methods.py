...
@pytest.mark.benchmark(mds=1.1, instances=10, iterations=5, burn_in_iterations=7)
...
@pytest.mark.benchmark(mds=1.1, instances=20, iteratins=5, burn_in_iterations=3)
@pytest.mark.xtimeout(120)
...
@pytest.mark.benchmark(mds=1.1, instances=10, iterations=10, burn_in_iterations=4)
