...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            1_000_000_000,
            1_000,
            marks=pytest.mark.benchmark(mds=1.2, instances=15, iterations=25, burn_in_iterations=20),
        ),
        pytest.param(
            1_000_000_000,
            1_000_000_000,
            marks=pytest.mark.benchmark(mds=1.1, instances=5, iterations=20, burn_in_iterations=10),
        ),
    ],
)
...
@pytest.mark.benchmark(mds=1.1, instances=15, iterations=15, burn_in_iterations=2)
...
@pytest.mark.benchmark(mds=1.1, instances=10, iterations=10, burn_in_iterations=2)
@pytest.mark.xtimeout(180)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            1_000_000, 1_000, marks=pytest.mark.benchmark(mds=1.1, instances=20, iterations=15, burn_in_iterations=8)
        ),
        pytest.param(
            1_000_000,
            1_000_000,
            marks=pytest.mark.benchmark(mds=1.1, instances=20, iterations=15, burn_in_iterations=20),
        ),
    ],
)
...
@pytest.mark.benchmark(mds=1.1, instances=15, iterations=25, burn_in_iterations=5)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            10_000_000, 10, marks=pytest.mark.benchmark(mds=1.1, instances=20, iterations=10, burn_in_iteratins=5)
        ),
        pytest.param(
            10_000_000, 100, marks=pytest.mark.benchmark(mds=1.1, instances=20, iterations=12, burn_in_iterations=3)
        ),
        pytest.param(
            10_000_000, 1000, marks=pytest.mark.benchmark(mds=1.2, instances=10, iterations=10, burn_in_iterations=7)
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            100, 1000, marks=pytest.mark.benchmark(mds=1.2, instances=15, iterations=10, burn_in_iterations=15)
        ),
        pytest.param(1000, 10, marks=pytest.mark.benchmark(mds=1.2, instances=15, iterations=5, burn_in_iterations=12)),
        pytest.param(
            1000, 100, marks=pytest.mark.benchmark(mds=1.2, instances=15, iterations=10, burn_in_iterations=6)
        ),
        pytest.param(
            1000, 1000, marks=pytest.mark.benchmark(mds=1.2, instances=10, iterations=10, burn_in_iterations=10)
        ),
    ],
    indirect=True,
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            10, 1000, marks=pytest.mark.benchmark(mds=1.2, instances=10, iterations=15, burn_in_iterations=14)
        ),
        pytest.param(100, 10, marks=pytest.mark.benchmark(mds=1.2, instances=10, iterations=10, burn_in_iterations=10)),
        pytest.param(
            100, 100, marks=pytest.mark.benchmark(mds=1.1, instances=15, iterations=20, burn_in_iterations=10)
        ),
        pytest.param(
            100, 1000, marks=pytest.mark.benchmark(mds=1.2, instances=15, iterations=5, burn_in_iterations=10)
        ),
        pytest.param(
            1000, 10, marks=pytest.mark.benchmark(mds=1.2, instances=10, iterations=20, burn_in_iterations=12)
        ),
        pytest.param(
            1000, 100, marks=pytest.mark.benchmark(mds=1.2, instances=10, iterations=20, burn_in_iterations=10)
        ),
        pytest.param(
            1000, 1000, marks=pytest.mark.benchmark(mds=1.2, instances=10, iterations=10, burn_in_iterations=10)
        ),
