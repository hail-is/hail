...
@pytest.mark.benchmark(mds=1.1, instances=10, iterations=10, burn_in_iterations=5)
...
@pytest.mark.benchmark(mds=1.2, instances=20, iterations=15, burn_in_iterations=5)
...
@pytest.mark.benchmark(mds=1.1, instances=10, iterations=5, burn_in_iterations=5)
