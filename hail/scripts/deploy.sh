...
[[ ${10} ]] || (echo "./deploy.sh HAIL_PIP_VERSION HAIL_VERSION GIT_VERSION REMOTE WHEEL GITHUB_OAUTH_HEADER_FILE HAIL_GENETICS_HAIL_IMAGE HAIL_GENETICS_HAILTOP_SLIM_IMAGE WHEEL_FOR_AZURE WEBSITE_TAR" ; exit 1)
...
HAIL_GENETICS_HAILTOP_SLIM_IMAGE=$8
WHEEL_FOR_AZURE=$9
WEBSITE_TAR=${10}

retry skopeo inspect $HAIL_GENETICS_HAIL_IMAGE || (echo "could not pull $HAIL_GENETICS_HAIL_IMAGE" ; exit 1)
retry skopeo inspect $HAIL_GENETICS_HAILTOP_SLIM_IMAGE || (echo "could not pull $HAIL_GENETICS_HAILTOP_SLIM_IMAGE" ; exit 1)
...
retry skopeo copy $HAIL_GENETICS_HAILTOP_SLIM_IMAGE docker://docker.io/hailgenetics/hailtop-slim:$HAIL_PIP_VERSION
retry skopeo copy $HAIL_GENETICS_HAILTOP_SLIM_IMAGE docker://gcr.io/hail-vdc/hailgenetics/hailtop-slim:$HAIL_PIP_VERSION
...
update_terra_image_py=$(pwd)/update-terra-image.py
