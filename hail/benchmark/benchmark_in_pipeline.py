...
if __name__ == '__main__':
    ...
    make_resources.command('tar -czvf benchmark-resources.tar.gz benchmark-resources')
    ...
    def make_task(name, replicate):
        ...
        t.command('tar -xvf benchmark-resources.tar.gz')
    ...
    print(f'writing output to f{output_file}')
