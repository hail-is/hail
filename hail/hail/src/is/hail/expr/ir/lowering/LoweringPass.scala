...
import is.hail.expr.ir.lowering.invariant.implicits._
...
case class OptimizePass(_context: String) extends LoweringPass {
  ...
  override def before: Invariant = NameNormalizedIr
  override def after: Invariant = NameNormalizedIr
...
case object LowerMatrixToTablePass extends LoweringPass {
  ...
  override def before: Invariant = NameNormalizedIr
  override def after: Invariant = NameNormalizedIr and NoMatrixIR
...
case object LiftRelationalValuesToRelationalLets extends LoweringPass {
  ...
  override def after: Invariant = NoMatrixIR and NoLiftMeOuts
...
case object LegacyInterpretNonCompilablePass extends LoweringPass {
  ...
  override def before: Invariant = NoMatrixIR
  override def after: Invariant = NoMatrixIR and NoRelationalLets and CompilableValueIRs
...
case object LowerOrInterpretNonCompilablePass extends LoweringPass {
  ...
  override def before: Invariant = NoMatrixIR
  override def after: Invariant = CompilableIR
...
case object InlineApplyIR extends LoweringPass {
  ...
  override def before: Invariant = CompilableIR
  override def after: Invariant = CompilableIR and NoApplyIR
...
case class EvalRelationalLetsPass(passesBelow: LoweringPipeline) extends LoweringPass {
  ...
  override def before: Invariant = NoMatrixIR and NoLiftMeOuts
