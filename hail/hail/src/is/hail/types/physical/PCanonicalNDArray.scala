...
final case class PCanonicalNDArray(elementType: PType, nDims: Int, required: Boolean = false)
  ...
  override def loadShapes(cb: EmitCodeBuilder, addr: Value[Long], settables: IndexedSeq[Settable[Long]])
    : Unit = {
  ...
  override def loadStrides(cb: EmitCodeBuilder, addr: Value[Long], settables: IndexedSeq[Settable[Long]])
    : Unit = {
  ...
  override def makeColumnMajorStrides(sourceShapeArray: IndexedSeq[Value[Long]], cb: EmitCodeBuilder)
  ...
  override def loadElement(cb: EmitCodeBuilder, indices: IndexedSeq[Value[Long]], ndAddress: Value[Long])
    : SValue = {
