...
case object Int32SingleCodeType extends SingleCodeType {
  ...
  override def loadToSValue(cb: EmitCodeBuilder, c: Value[_]): SValue = new SInt32Value(coerce[Int](c))

  override def virtualType: Type = TInt32

  override def coerceSCode(cb: EmitCodeBuilder, pc: SValue, region: Value[Region], deepCopy: Boolean)
    : SingleCodeSCode =
...
case object Int64SingleCodeType extends SingleCodeType {
  ...
  override def loadToSValue(cb: EmitCodeBuilder, c: Value[_]): SValue = new SInt64Value(coerce[Long](c))
...
case object Float32SingleCodeType extends SingleCodeType {
  ...
  override def loadToSValue(cb: EmitCodeBuilder, c: Value[_]): SValue = new SFloat32Value(coerce[Float](c))
...
case object Float64SingleCodeType extends SingleCodeType {
  ...
  override def loadToSValue(cb: EmitCodeBuilder, c: Value[_]): SValue = new SFloat64Value(coerce[Double](c))
...
case object BooleanSingleCodeType extends SingleCodeType {
  ...
  override def loadToSValue(cb: EmitCodeBuilder, c: Value[_]): SValue = new SBooleanValue(coerce[Boolean](c))
