...
class LocusIntervalSuite extends HailSuite {
  ...
  @Test def testParser(): Unit = {
    ...
    assert(Locus.parseInterval("[1:100-1:101)", rg) == Interval(
      Locus("1", 100),
      Locus("1", 101),
      true,
      false,
    ))
    assert(Locus.parseInterval("[1:100-101)", rg) == Interval(
      Locus("1", 100),
      Locus("1", 101),
      true,
      false,
    ))
    assert(Locus.parseInterval("[X:100-101)", rg) == Interval(
      Locus("X", 100),
      Locus("X", 101),
      true,
      false,
    ))
    assert(Locus.parseInterval("[X:100-end)", rg) == Interval(
      Locus("X", 100),
      Locus("X", xMax),
      true,
      false,
    ...
    assert(Locus.parseInterval("[X:start-101)", rg) == Interval(
      Locus("X", 1),
      Locus("X", 101),
      true,
      false,
    ...
    assert(Locus.parseInterval("[X:START-Y:END)", rg) == Interval(
      Locus("X", 1),
      Locus("Y", yMax),
      true,
      false,
    ))
    assert(Locus.parseInterval("[X-Y)", rg) == Interval(
      Locus("X", 1),
      Locus("Y", yMax),
      true,
      false,
    ))
    assert(Locus.parseInterval("[1-22)", rg) == Interval(
      Locus("1", 1),
      Locus("22", chr22Max),
      true,
      false,
    ...
    assert(Locus.parseInterval(s"(X:100-${xMax + 1})", rg) == Interval(
      Locus("X", 100),
      Locus("X", xMax),
      false,
      true,
    ))
    assert(Locus.parseInterval(s"(X:0-$xMax]", rg) == Interval(
      Locus("X", 1),
      Locus("X", xMax),
      true,
      true,
    ...
    assert(Locus.parseInterval("[16:29500000-30200000)", rg) == Interval(
      Locus("16", 29500000),
      Locus("16", 30200000),
      true,
      false,
    ))
    assert(Locus.parseInterval("[16:29.5M-30.2M)", rg) == Interval(
      Locus("16", 29500000),
      Locus("16", 30200000),
      true,
      false,
    ))
    assert(Locus.parseInterval("[16:29500K-30200K)", rg) == Interval(
      Locus("16", 29500000),
      Locus("16", 30200000),
      true,
      false,
    ))
    assert(Locus.parseInterval("[1:100K-2:200K)", rg) == Interval(
      Locus("1", 100000),
      Locus("2", 200000),
      true,
      false,
    ...
    assert(Locus.parseInterval("[1:1.111K-2000)", rg) == Interval(
      Locus("1", 1111),
      Locus("1", 2000),
      true,
      false,
    ))
    assert(Locus.parseInterval("[1:1.111111M-2000000)", rg) == Interval(
      Locus("1", 1111111),
      Locus("1", 2000000),
      true,
      false,
