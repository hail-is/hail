...
import is.hail.utils.{Interval, triangle, uniqueMaxIndex}
...
import org.scalacheck.Gen.{identifier, resultOf}

import scala.annotation.switch

trait GenTypeInstances {
  def genNumericType: Gen[TNumeric] =
    Gen.oneOf(
      TInt32,
      TInt64,
      TFloat32,
