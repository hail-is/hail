...
class LogisticRegressionModelSuite extends HailSuite {
  ...
  @Test def covariatesVsInterceptOnlyTest(): scalatest.Assertion = {
  ...
  @Test def gtsAndCovariatesVsCovariatesOnlyTest(): scalatest.Assertion = {
  ...
  @Test def firthSeparationTest(): scalatest.Assertion = {
