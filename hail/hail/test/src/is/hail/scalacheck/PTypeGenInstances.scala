...
import is.hail.scalacheck.PTypeGenInstances.DefaultRequiredGenRatio
...
private[scalacheck] object PTypeGenInstances {
  val DefaultRequiredGenRatio = 0.2
}

private[scalacheck] trait PTypeGenInstances {
