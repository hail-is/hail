...
class StringFunctionsSuite {
  implicit val execStrats: Set[ExecStrategy] = ExecStrategy.javaOnly

  @Test def testRegexMatch(implicit ctx: ExecuteContext): Unit = {
  ...
  @Test def testLength(implicit ctx: ExecuteContext): Unit = {
  ...
  @Test def testSubstring(implicit ctx: ExecuteContext): Unit = {
  ...
  @Test def testConcat(implicit ctx: ExecuteContext): Unit = {
  ...
  @Test def testSplit(implicit ctx: ExecuteContext): Unit = {
  ...
  @Test def testReplace(implicit ctx: ExecuteContext): Unit = {
  ...
  @Test def testArrayMkString(implicit ctx: ExecuteContext): Unit = {
  ...
  @Test def testSetMkString(implicit ctx: ExecuteContext): Unit = {
  ...
  @Test def testFirstMatchIn(implicit ctx: ExecuteContext): Unit = {
  ...
  @Test def testHammingDistance(implicit ctx: ExecuteContext): Unit = {
  ...
  def timeData() = ArraySeq[(String, String, Long)](
    // □ = untested
    // ■ = tested
    // ⊗ = unimplemented
